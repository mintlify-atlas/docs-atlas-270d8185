...
<CardGroup cols={2}>
  ...
  <Card title="Pack Command" icon="box" href="/guides/packaging">
    PyInstaller packaging
  </Card>
  <Card title="Distribution Guide" icon="share-nodes" href="/guides/packaging">
    Learn about app distribution
  </Card>
  <Card title="Icons & Splash" icon="image" href="/guides/packaging">
